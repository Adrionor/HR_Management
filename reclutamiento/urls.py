# reclutamiento/urls.py
from django.urls import path
from . import views

urlpatterns = [
    # Página de inicio pública y Dashboard interno
    path('', views.lista_vacantes_publica_view, name='homepage_publica'),
    path('dashboard/', views.dashboard, name='dashboard'),


    # Flujo de Candidatos y Asesoras
    path('bolsa-trabajo/', views.bolsa_trabajo_view, name='bolsa_trabajo'),
    ...
    # Flujo de Gerentes y Directores
    ...
    path('recuperar-clave/', views.password_reset_info_view, name='recuperar_clave_info'),
