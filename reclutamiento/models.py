...
class Proceso(models.Model):
    ...
    puesto = models.ForeignKey('Puesto', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Puesto Aplicado")
...
class PerfilDePuesto(models.Model):
    ...
    # OBLIGATORIOS (blank=False por defecto)
    habilidades_clave = models.TextField(verbose_name="Habilidades Clave (Indispensables)")
    rasgos_personalidad = models.TextField(verbose_name="Rasgos de Personalidad Ideales")

    # OPCIONALES (mantenemos blank=True)
    habilidades_deseables = models.TextField(blank=True, verbose_name="Habilidades Deseables (Plus)")
    preguntas_sugeridas = models.TextField(blank=True, verbose_name="Preguntas Sugeridas para Entrevista")
    ...
    def __str__(self):
        return f"Perfil para {self.puesto.titulo}"
